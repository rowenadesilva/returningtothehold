...
function Scroll() {
  ...
  // SCROLL LOOP LOGIC - INFINITE LOOP OF LINE AND TRACKER
  useEffect(() => {
    ...
    divRef.addEventListener("scroll", function () {
      ...
      if (pageLength === 1) {
        ...
        yPos = this.scrollTop - scrollMax * (pageLength - 1);
        console.log("y2 :" + yPos);
      }
      yPos = yPos * 0.7;
      ...
      trackerRef.style.offsetDistance = percentage * 0.5 + "%";

      var d = trackerRef.style.offsetDistance;
      d = d.slice(0, -1);
      d = parseInt(d);
      console.log("d: " + d);
      ...
      if (d >= 49) {
        ...
        console.log("END!");
        d = 0;
        scrollMax = this.scrollTop;
        const list = document.getElementsByClassName("li");
        const el = list[list.length - 1];
        const offset = el.getBoundingClientRect().top;
        trackerRef.style.transform =
          "translateY(" + (scrollMax + offset) + "px)";
        trackerRef.style.offsetDistance = "0%";
      }

      // if (percentage / 2 >= 10 && percentage / 2 <= 18) {
  ...
  return (
    <div className="App">
      <div className="block" id="container">
        <div className="tracker" id="trackerRef"></div>
        <div className="ul" data-current="0">
          <div className="li">
            <svg className="line">
              <path
                d="M629.4,99.9c10.2,39.9,52.3,58.6,90,60.7c34,1.8,68.1-3.7,101.9,1.5c46.1,7.1,78.7,35.9,103.1,74.5
			...
			c-56-1.5-145.5,13.3-164.2-59.4C630,99.3,629.3,99.5,629.4,99.9L629.4,99.9z"
              />
            </svg>
          </div>
        </div>
      ...
      <div className="archiveCard" id="card1Ref">
        CARD 1
      </div>
    </div>
  );
